       ...
       <div class="container">
            <div class="row">
					...
					if(isset($_SESSION['success'])){
					  echo "
						<div class='alert alert-success alert-dismissible' style='background:green;color:#fff'>
						  <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
						  <h4><i class='icon fa fa-check'></i> Sceneado!</h4>
						  ".$_SESSION['success']."
						</div>
					  ";
                ...
                <form action="CheckInOut.php" method="post" class="form-horizontal" style="border-radius: 5px;padding:10px;background:#fff;" id="divvideo">
                     <i class="glyphicon glyphicon-qrcode"></i> <label>SCANNEO QR</label> <p id="time"></p>
                    <input type="text" name="nocuenta" id="text" placeholder="scanea QR" class="form-control"   autofocus>
                </form>
                  ...
                  <table id="example1" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        if($conn->connect_error){
                           ...
                           $sql ="SELECT * FROM asistencia LEFT JOIN usuarios ON asistencia.nocuenta=usuarios.nocuenta WHERE fecha='$date'";
				...
				<button type="submut" class="btn btn-succes pull-right" onclick="Export()">
		...
		<script>
			function Export()
			{
				var conf = confirm("Confirme bajar reporte");
				if(conf == true)
				{

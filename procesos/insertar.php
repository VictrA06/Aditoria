<?php
    ...
    $query = "INSERT INTO tbl_entidad(entidad_ruc_dni, entidad_razon_social, entidad_direccion,entidad_estado) VALUES ('$nocuenta','$nombre'+'$apellido_mat'+'$apellido_mat','$correo','1')";

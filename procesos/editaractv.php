...
<html>
    ...
    <?php
        ...
        $id = $_REQUEST['id'];
        $query = "SELECT * FROM actividades WHERE id_actv ='$id'";
            ...
            <nav class="navbar navbar-default" role="navigation">
             ...
             <h1>Editar actividad</h1>
                <form action="../procesos/procesoeditaractv.php" class="col-6" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" class="form-control" name="nombre" required value="<?php echo $row['nombre_actv'];?>" pattern="[a-zA-Z]{5,30}" maxlength="30" title="El nombre de la actividad debe ser mayor mayor a 5 caracteres">
                    <label>Precio de la actividad</label>
                    <input type="number" class="form-control" name="precio" required value="<?php echo $row['precio'];?>" title="Introduce solo numeros">
                    <br>
                    <div class="btnActv">

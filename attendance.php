    ...
    <body style="background:#eee">
       ...
       <div class="container">
			   ...
			   <table id="example1" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        if($conn->connect_error){
                           ...
                           $sql ="SELECT * FROM asistencia LEFT JOIN usuarios ON asistencia.nocuenta=usuarios.nocuenta";
		...
		<script>
			function Export()
			{
				var conf = confirm("Confirme si desea exportar la asistencia a un archivo de Excel");
				if(conf == true)
				{

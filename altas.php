                        ...
                        <div class="panel-body">
                            <form action="procesos/insertar.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="numeric" class="form-control" name="id" required pattern="[0-9]{8,8}" title="El numero de cuenta no tiene que ser menor a 8 digitos"/>
                                </div>
                                <label>Usuario</label>
                                ...
                                <script>
                                    let usuario =["Usuario Interno","Usuario Externo"];
                                    let tipoUs =["Estudiante","Docente","Administrativo", "Niño", "Adulto"];
                                    ...
                                    combobox1.addEventListener('change', (e)=>{
                                        ...
                                        switch (dato) {
                                            case 'Usuario Interno':
                                                ...
                                                Recorrer(combobox2,tipoUs.slice(0,3))

                                                break;
                                             case 'Usuario Externo':

                                                Recorrer(combobox2,tipoUs.slice(3,5))
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nombre" required pattern="[a-zA-Z]{2,30}" maxlength="30" title="Nombre debe contener minimo 2 caracteres y maximo 30"/>
                                </div>
                                <div class="form-group">
                                  <label for=""">Apellido Paterno</label>
                                  <input type="text" class="form-control" name="apellido_pat" required pattern="[a-zA-Z]{2,30}" maxlength="30" title="Apellido debe contener minimo 2 caracteres y maximo 30"/>
                              </div>
                              <div class="form-group">
                                <label for=""">Apellido Materno</label>
                                <input type="text" class="form-control" name="apellido_mat" required pattern="[a-zA-Z]{2,30}" maxlength="30" title="Apellido debe contener minimo 2 caracteres y maximo 30"/>
                            </div>
                            <div class="form-group">
